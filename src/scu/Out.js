...
const Cek = async (reg) => {
  const link = ""+host_custom+"/listscuout?X-Api-Key="+token+"&regional="+reg+"";
   //lm = parseInt(limit);
...
const All = ({detail,schedule_id,schedule_code,document_bag_no,document_sticker,dodument_seal_no,client_type,schedule_date,nominal_pickup,schdeule_delivery_type,schedule_delivery_name,schedule_progress,client2_name,no_da,document_bag_cpc,document_seal_cpc,document_sticker_cpc,nominal_custody,schedule_delivery_address}) => {
return (
<View>  
...
:schedule_progress==7?
<Text numberOfLines={2}
style={{width: lebar,fontSize:20,color:Gr_,fontWeight:'bold',marginBottom:2}}>Proses CPC
</Text>
:
<Text numberOfLines={2}
...
<Text numberOfLines={1}
style={{width: lebar,fontSize:16,color:Cl3_,fontWeight:'bold',marginBottom:2}}>No Bag Custody : {document_bag_no} 
</Text>
<Text numberOfLines={1}
style={{width: lebar,fontSize:16,color:Cl3_,fontWeight:'bold',marginBottom:2}}>No Sticker Custody : {document_sticker} 
</Text>
<Text numberOfLines={1}
style={{width: lebar,fontSize:16,color:Cl3_,fontWeight:'bold',marginBottom:2}}>No Seal Custody : {dodument_seal_no} 
</Text>
<Text numberOfLines={1}
style={{width: lebar,fontSize:16,color:Cl3_,fontWeight:'bold',marginBottom:2}}>No Bag CPC : {document_bag_cpc} 
</Text>
<Text numberOfLines={1}
style={{width: lebar,fontSize:16,color:Cl3_,fontWeight:'bold',marginBottom:2}}>No Sticker CPC : {document_sticker_cpc} 
</Text>
<Text numberOfLines={1}
style={{width: lebar,fontSize:16,color:Cl3_,fontWeight:'bold',marginBottom:2}}>No Seal CPC : {document_seal_cpc} 
</Text>
<Text numberOfLines={1}
style={{width: lebar,fontSize:16,color:Cl3_,fontWeight:'bold',marginBottom:2}}>No DA : {no_da} 
</Text>
...
dodument_seal_no={us.document_seal_no} 
