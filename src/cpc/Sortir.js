...
const Cek_value = async () => {fetch(link1).then((response) => response.json())
           .then((responseJson) =>
           {
...
<Text style={{fontFamily: "sans-serif", margin:1, fontSize: 18, color :'grey'}}>Value</Text>
<View style={styles.cont1_}>
 <TextInput style={styles.input1}
    ...
    <Text style={{fontFamily: "sans-serif", margin:10,color:'green', fontSize: 20}}>Nominal IDR :{jumlah}</Text>
